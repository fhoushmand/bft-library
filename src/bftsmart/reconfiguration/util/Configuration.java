...
public class Configuration {
	...
	public Configuration(int procId, KeyLoader loader, int clusterId) {
	...
	public Configuration(int procId, String configHomeParam, KeyLoader loader, int clusterId) {
		logger = LoggerFactory.getLogger(this.getClass());
		processId = procId;
	...
	protected void init() {
		...
		try {
			...
			// read instance id from system.config and set hosts.config file accordingly
			hosts = new HostsConfig(configHome, hostsFileName, configs.get("system.servers.processNumber"));
	...
	public final int getServerToServerRMIPort(int id) {
		return hosts.getServerToServerRMIPort(id);
	}
	...
	public final void addHostInfo(int id, String host, int port, int portRR, int rmiPort) {
		this.hosts.add(id, host, port, portRR, rmiPort);
	}
