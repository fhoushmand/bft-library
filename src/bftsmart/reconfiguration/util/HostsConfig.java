...
public class HostsConfig {
    ...
    public HostsConfig(String configHome, String fileName, String instanceId) {
        loadConfig(configHome, fileName, instanceId);
    }
    
    private void loadConfig(String configHome, String fileName, String instanceId){
        try{
            String path =  "";
            String sep = System.getProperty("file.separator");
            /* Old hosts.config reader
            ...
            if(configHome.equals("")){
                ...
                if (fileName.equals(""))
                    ...
                    path = configHome+sep+fileName+instanceId;
            }
    ...
    public void add(int id, String host, int port, int portRR, int rmiPort){
    ...
    public int getServerToServerRMIPort(int id){
        Config c = (Config) this.servers.get(id);
        if(c != null){
            return c.rmiPort;
        }
    ...
    public class Config{
        ...
        public Config(int id, String host, int port, int portRR, int rmiPort){
            this.id = id;
            this.host = host;
            this.port = port;
            this.portRR = portRR;
