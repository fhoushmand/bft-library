...
public class ViewManager {
    ...
    public ViewManager(KeyLoader loader, int clusterId) {
        this("", loader, clusterId);
    }

    public ViewManager(String configHome, KeyLoader loader, int clusterId) {
        this.id = loadID(configHome);
        this.controller = new ServerViewController(id, configHome, loader, clusterId);
        this.rec = new Reconfiguration(id, configHome, loader, clusterId);
    }
    ...
    public void addServer(int id, String ip, int port, int portRR, int rmiPort) {
        this.controller.getStaticConf().addHostInfo(id, ip, port, portRR, rmiPort);
