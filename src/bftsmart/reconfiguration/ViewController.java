...
public class ViewController {
    ...
    public ViewController(int procId, KeyLoader loader, int clusterId) {
        this.staticConf = new TOMConfiguration(procId, loader, clusterId);
    }

    
    public ViewController(int procId, String configHome, KeyLoader loader, int clusterId) {
        this.staticConf = new TOMConfiguration(procId, configHome, loader, clusterId);
    }
