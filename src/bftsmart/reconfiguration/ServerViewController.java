...
public class ServerViewController extends ViewController {
   ...
   // protected View initialView;
    ...
    public ServerViewController(int procId, KeyLoader loader, int clusterId) {
        this(procId,"", loader, clusterId);
        /*super(procId);
    ...
    public ServerViewController(int procId, String configHome, KeyLoader loader, int clusterId) {
        super(procId, configHome, loader, clusterId);
                ...
                if (key == ADD_SERVER) {
                    ...
                    if (str.countTokens() > 2) {
                        ...
                        if(!isCurrentViewMember(id) && !contains(id, jSet)){
                            ...
                            this.getStaticConf().addHostInfo(id, host, port, portRR, rmiPort);
                        }
                    }
