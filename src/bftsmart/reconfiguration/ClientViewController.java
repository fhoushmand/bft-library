...
public class ClientViewController extends ViewController {
    ...
    public ClientViewController(int procId, KeyLoader loader, int clusterId) {
        super(procId, loader, clusterId);
    ...
    public ClientViewController(int procId, String configHome, KeyLoader loader, int clusterId) {
