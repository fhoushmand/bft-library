...
public class ReconfigurationTest {
    ...
    public void run(int id, int clusterId){
       /* ServiceProxy proxy = new ServiceProxy(id);
        ...
        Reconfiguration rec = new Reconfiguration(id, "", null, clusterId);
    ...
    public static void main(String[] args){
        new ReconfigurationTest().run(Integer.parseInt(args[0]),Integer.parseInt(args[1]));
    }
