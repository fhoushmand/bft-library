...
public class VMServices {
     ...
     */
    public void addServer(int id, String ipAddress, int port, int portRR, int rmiPort, int clusterId) {
        
        ViewManager viewManager = new ViewManager(configDir, keyLoader, clusterId);
        
        viewManager.addServer(id, ipAddress, port, portRR, rmiPort);
     ...
     */
    public void removeServer (int id, int clusterId) {
        
        ViewManager viewManager = new ViewManager(keyLoader, clusterId);
