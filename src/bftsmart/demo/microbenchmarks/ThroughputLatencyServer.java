...
public final class ThroughputLatencyServer extends DefaultRecoverable{
    ...
    public ThroughputLatencyServer(int id, int interval, int replySize, int stateSize, boolean context,  int signed, int write, int clusterId) {
        ...
        replica = new ServiceReplica(id, this, this, clusterId);
    }
    ...
    public static void main(String[] args){
        if(args.length < 7) {
            System.out.println("Usage: ... ThroughputLatencyServer <processId> <measurement interval> <reply size> <state size> <context?> <nosig | default | ecdsa> <cluster id> [rwd | rw]");
            System.exit(-1);
        }
        ...
        int clusterId = Integer.valueOf(args[6]);
        ...
        new ThroughputLatencyServer(processId,interval,replySize, stateSize, context, s, w, clusterId);
    }
