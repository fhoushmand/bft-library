 ...
 * 
 */
package bftsmart.hermes.orchestration;
...
import bftsmart.hermes.orchestration.remote.AddAspectRemoteAction;
import bftsmart.hermes.orchestration.remote.AddAspectRemoteActionResult;
import bftsmart.hermes.orchestration.remote.GetStateActionResult;
import bftsmart.hermes.orchestration.remote.GetStateRemoteAction;
import bftsmart.hermes.orchestration.remote.RemoteAction;
...
public class OrchestrationNodeServerClient {
    ...
    public RemoteActionResult remoteAction(RemoteAction notification, long timeout) throws Exception {
        ...
        try {
            ...
            if (replyAbs == null) {
                Logger.getLogger(OrchestrationNodeServerClient.class.getName()).log(Level.SEVERE, "OrchestrationNodeServerClient:remoteAction() remote action FAILED");
