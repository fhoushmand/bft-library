 ...
 */
public class RuntimeLeaveNotification extends Notification{
    
    public static final int RUNTIMELEAVENOTIFICATION_SERIALID = 142386210;
            
    public RuntimeLeaveNotification(){
     super();   
    }
    
    public RuntimeLeaveNotification(String srcID){
        super(srcID);
    }
