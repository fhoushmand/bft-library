 ...
 */
public class RuntimeJoinNotification extends Notification{
    
    public final static int RUNTIMEJOINNOTIFICATION_SERIALID = 142386284;
            
    public RuntimeJoinNotification(){
        super();
    }
    
    public RuntimeJoinNotification(String srcID){
        super(srcID);        
    }
