 ...
 * 
 */
package bftsmart.hermes.orchestration.remote;
 ...
 */
public class RemoteActionResultImpl extends RemoteActionResult {

    public static int SERIAL_ID = 6000001;
    protected byte[] m_result;

    public RemoteActionResultImpl(){        
    }
    
    public RemoteActionResultImpl(byte[] result){
        m_result = result;
    }
