...
/**
     ...
     * @see bellow
     */
    public AsynchServiceProxy(int processId, int clusterId) {
        this(processId, null, clusterId);
        init();
    }
...
/**
     ...
     * @see bellow
     */
    public AsynchServiceProxy(int processId, String configHome, int clusterId) {
        super(processId, configHome, clusterId);
        init();
    }
     ...
     * @see bellow
     */
    public AsynchServiceProxy(int processId, String configHome, KeyLoader loader, int clusterId) {
        super(processId, configHome, loader, clusterId);
        init();
    }
    ...
    public AsynchServiceProxy(int processId, String configHome,
        ...
        super(processId, configHome, replyComparator, replyExtractor, loader, clusterId);
        init();
    }
