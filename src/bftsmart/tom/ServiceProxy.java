...
public class ServiceProxy extends TOMSender {
	 ...
	 * @see bellow
	 */
	public ServiceProxy(int processId, int clusterId) {
		this(processId, null, null, null, null, clusterId);
	}
	 ...
	 * @see bellow
	 */
	public ServiceProxy(int processId, String configHome, int clusterId) {
		this(processId, configHome, null, null, null, clusterId);
	}
	 ...
	 * @see bellow
	 */
        public ServiceProxy(int processId, String configHome, KeyLoader loader, int clusterId) {
		this(processId, configHome, null, null, loader, clusterId);
	}
	...
	public ServiceProxy(int processId, String configHome,
			Comparator<byte[]> replyComparator, Extractor replyExtractor, KeyLoader loader, int clusterId) {
		if (configHome == null) {
			init(processId, loader, clusterId);
		} else {
			init(processId, configHome, loader, clusterId);
		}
