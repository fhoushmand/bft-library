...
public class ServiceReplica {
     ...
     */
    public ServiceReplica(int id, Executable executor, Recoverable recoverer, int clusterId) {
        this(id, "", executor, recoverer, null, new DefaultReplier(), null, clusterId);
    }
     ...
     */
    public ServiceReplica(int id, Executable executor, Recoverable recoverer, RequestVerifier verifier, int clusterId) {
        this(id, "", executor, recoverer, verifier, new DefaultReplier(), null, clusterId);
    }
     ...
     */
    public ServiceReplica(int id, String configHome, Executable executor, Recoverable recoverer, RequestVerifier verifier, Replier replier, KeyLoader loader, int clusterId) {
        this.id = id;
        this.SVController = new ServerViewController(id, configHome, loader, clusterId);
    ...
    private void init() {
        ...
        logger.info("Cluster ID: " + this.SVController.getClusterId());
