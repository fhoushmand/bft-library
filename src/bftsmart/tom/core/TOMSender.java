...
public abstract class TOMSender implements ReplyReceiver, Closeable, AutoCloseable {
	 ...
	 */
	public void init(int processId, KeyLoader loader, int clusterId) {
		this.viewController = new ClientViewController(processId, loader, clusterId);
		startsCS(processId);
	}

	public void init(int processId, String configHome, KeyLoader loader, int clusterId) {
		this.viewController = new ClientViewController(processId,configHome, loader, clusterId);
		startsCS(processId);
	}
