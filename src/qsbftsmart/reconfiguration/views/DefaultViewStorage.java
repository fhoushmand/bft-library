...
*/
package qsbftsmart.reconfiguration.views;
...
public class DefaultViewStorage implements ViewStorage {
    ...
    public DefaultViewStorage(String configPath, String id) {
        ...
        path = path + System.getProperty("file.separator") + "currentView" + id;
    }
